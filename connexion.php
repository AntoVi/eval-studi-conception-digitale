...
if(isset($_POST['email'], $_POST['password']))
{
    ...
    // SELECTIONNE TOUT EN BDD A CONDITION QUE le pseudo OU l'email SOIT EGALE aux colonnes email de la BDD
    //                                                                GregFormateur            azdazdazd
    $verifCredentials = $db->prepare("SELECT * FROM admin WHERE email = :email");
    $verifCredentials->bindValue(':email', $_POST['email'], PDO::PARAM_STR);
