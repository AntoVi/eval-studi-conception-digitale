...
if($_POST){
    ...
    && isset($_POST['nationalite']) && !empty($_POST['nationalite'])){
        ...
        $sql = 'INSERT INTO `contact` (`nom`, `prenom`,`birthdate`, `codename`, `nationalite`) VALUES (:nom, :prenom, :birthdate, :codename, :nationalite);';
        ...
        <div class="row">
            <section class="col-12">
                ...
                <form method="post">
                    ...
                    <a href="listeContact.php" class="btn btn-primary mt-3">Retour</a>
                </form>
            </section>
        </div>
    </main>
